...
export const CONTACT_ME_SUBTITLE_TEXT_ENG = "I'm always open to discussing new projects, creative ideas, or opportunities to be part of your vision.";
export const CONTACT_ME_TEXT_ENG = "Email Me";
export const CONTACT_ME_SOCIAL_MEDIA_TEXT_ENG = "Connect with me";
export const CONTACT_SECTION_ENG = "Let's Build Something Great Together";
